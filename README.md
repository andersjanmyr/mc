...
* [OS X](https://github.com/andersjanmyr/mc/releases/download/v1.4.0/mc-osx)
* [Linux](https://github.com/andersjanmyr/mc/releases/download/v1.4.0/mc-linux)
* [Windows](https://github.com/andersjanmyr/mc/releases/download/v1.4.0/mc.exe)

### Curl

```
# OS X
$ curl -L https://github.com/andersjanmyr/mc/releases/download/v1.4.0/mc-osx \
  > /usr/local/bin/mc

# Linux
$ curl -L https://github.com/andersjanmyr/mc/releases/download/v1.4.0/mc-linux \
  > /usr/local/bin/mc
